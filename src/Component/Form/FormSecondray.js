            ...
            <Form className={style.formColor}>
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridName2">
                        ...
                        <Form.Control className={style.controlInputSecondray} type="text" placeholder="Enter Name" />
                    </Form.Group>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridNewPassward2">
                        <Form.Label className={style.labelTitle}>Passward</Form.Label>
                        <Form.Control className={style.controlInputSecondray} type="passward" placeholder="Old Passward" />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridOldPassword2">
                        <Form.Label className={style.labelTitle}> New Password</Form.Label>
                        <Form.Control className={style.controlInputSecondray} type="current-password" placeholder=" New Password" />
                    </Form.Group>
                </Form.Row>
                ...
                <Form.Row>
                    ...
                    <Form.Group as={Col} controlId="formGridAddress3">
                        ...
                        <Form.Control type="text" className={style.controlInputSecondray} placeholder="Enter Main Address" />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridAddress4">
                        <Form.Label className={style.labelTitle}>Address 2</Form.Label>
                        <Form.Control type="text" className={style.controlInputSecondray} placeholder="Enter Second Address" />
                    </Form.Group>
                ...
                <Form.Row>
                    <Form.Group className='d-flex mr-5 flex-column ' >
                        ...
                        <DatePicker
                            ...
                            format="dd-MM-y"
                            className={style.secondryPicker}
                            calendarAriaLabel="target"
                            calendarClassName={style.secondryBodyColorPicker}
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridNumber1">
                        <Form.Label className={style.labelTitle}>Number 01</Form.Label>
                        <Form.Control type='tel' placeholder='Enter Number' className={style.controlInputSecondray} />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridNumber2">
                        <Form.Label className={style.labelTitle}>Number 02</Form.Label>
                        <Form.Control type='tel' placeholder='Enter Work Number' className={style.controlInputSecondray} />
                    </Form.Group>
                </Form.Row>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridCity1">
                        ...
                        <Form.Control type='text' placeholder='Enter City' className={style.controlInputSecondray} />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridState2">
                        <Form.Label className={style.labelTitle}>State</Form.Label>
                        <Form.Control className={style.controlInputSecondray} as="select">
                    ...
                    <Form.Group as={Col} controlId="formGridZip1">
                        ...
                        <Form.Control type='Number' placeholder='33AQ78'  className={style.controlInputSecondray} />
                    </Form.Group>
                </Form.Row>
